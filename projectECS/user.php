...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO projectecs (faculty, title, author, publisher, ledition, lyear, link) VALUES ('$faculty','$title', '$author', '$publisher', '$ledition', '$lyear', '$link')";
    ...
    <div class="container my-5">
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter Faculty Name:" name="faculty" autocomplete="off">
            </div>
            <div class="mb-3">
                <label>Title</label>
